...
func (uc *UserCreate) SetOrgID(i int) *UserCreate {
	uc.mutation.SetOrgID(i)
	return uc
}

// AddAuditIDs adds the "audits" edge to the Audit entity by IDs.
func (uc *UserCreate) AddAuditIDs(ids ...int) *UserCreate {
	uc.mutation.AddAuditIDs(ids...)
	return uc
}

// AddAudits adds the "audits" edges to the Audit entity.
func (uc *UserCreate) AddAudits(a ...*Audit) *UserCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
...
func (uc *UserCreate) SetOrganizationsID(id int) *UserCreate {
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.OrgID(); !ok {
		return &ValidationError{Name: "org_id", err: errors.New(`ent: missing required field "User.org_id"`)}
	}
	if _, ok := uc.mutation.OrganizationsID(); !ok {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.AuditsIDs(); len(nodes) > 0 {
