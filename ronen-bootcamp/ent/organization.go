...
type Organization struct {
	...
	// Revenues holds the value of the "revenues" field.
	Revenues float64 `json:"revenues,omitempty"`
...
// was not loaded in eager-loading.
func (e OrganizationEdges) AuditsOrErr() ([]*Audit, error) {
	if e.loadedTypes[1] {
		return e.Audits, nil
	}
...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case organization.FieldRevenues, organization.FieldSecurityScore:
	...
	for i := range columns {
		...
		case organization.FieldRevenues:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field revenues", values[i])
			} else if value.Valid {
				o.Revenues = value.Float64
			}
		case organization.FieldSecurityScore:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field security_score", values[i])
			} else if value.Valid {
				o.SecurityScore = value.Float64
			}
		}
	}
	return nil
...
// QueryAudits queries the "audits" edge of the Organization entity.
func (o *Organization) QueryAudits() *AuditQuery {
	return (&OrganizationClient{config: o.config}).QueryAudits(o)
}
...
func (o *Organization) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("revenues=")
	builder.WriteString(fmt.Sprintf("%v", o.Revenues))
	builder.WriteString(", ")
	builder.WriteString("security_score=")
	builder.WriteString(fmt.Sprintf("%v", o.SecurityScore))
	builder.WriteByte(')')
